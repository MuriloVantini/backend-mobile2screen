...
return [
    ...
    'attributes' => [
        ...
        'notification_phone' => 'telefone de notificação',
        'notify_alert_failed' => 'notificação de falha no alerta',
        'notify_device_connected' => 'notificação de dispositivo conectado',
        'notify_device_offline' => 'notificação de dispositivo offline',
        'notify_limit_reached' => 'notificação de limite atingido',
        'notify_weekly_report' => 'notificação de relatório semanal',
        'password' => 'senha',
